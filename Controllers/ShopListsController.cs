...
namespace Mechetiuc_Denisa_Lab12.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Mechetiuc_Denisa_Lab12Context _context;

        public ShopListsController(Mechetiuc_Denisa_Lab12Context context)
        {
            _context = context;
        }
